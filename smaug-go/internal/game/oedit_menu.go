...
// The per-item-type value menu dispatchers (oeditDispVal1Menu through
// oeditDispVal6Menu) live in oedit_values.go (Wave 3 G7). Container-flags
// and lever-flags helper menus live there too.
